...
# filedir = os.path.join('data',ruleset,rnn_type,activation,init,str(len(rule_trains))+'_tasks',
#     str(n_rnn)+'_n_rnn','lr'+str(-lr)+'l2_w'+str(-l2w)+'_h'+str(-l2h)+'_'+rule_trains_str,folder)
